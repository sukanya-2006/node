...
## 2025-08-27, Version 20.19.5 'Iron' (LTS), @marco-ippolito

### Notable Changes

* \[[`0ac38a150c`](https://github.com/nodejs/node/commit/0ac38a150c)] - **doc**: add JonasBa to collaborators (Jonas Badalic) [#58355](https://github.com/nodejs/node/pull/58355)
* \[[`4ccac5abba`](https://github.com/nodejs/node/commit/4ccac5abba)] - **doc**: add puskin to collaborators (Giovanni Bucci) [#58308](https://github.com/nodejs/node/pull/58308)
* \[[`fdf803cdfe`](https://github.com/nodejs/node/commit/fdf803cdfe)] - **doc**: add Filip Skokan to TSC (Rafael Gonzaga) [#58499](https://github.com/nodejs/node/pull/58499)
* \[[`21853cebfb`](https://github.com/nodejs/node/commit/21853cebfb)] - **doc**: add @geeksilva97 to collaborators (Edy Silva) [#57241](https://github.com/nodejs/node/pull/57241)

### Commits

* \[[`5c3cd7bbef`](https://github.com/nodejs/node/commit/5c3cd7bbef)] - **build**: fix pointer compression builds (Joyee Cheung) [#58171](https://github.com/nodejs/node/pull/58171)
* \[[`294beb65e5`](https://github.com/nodejs/node/commit/294beb65e5)] - **build**: disable v8\_enable\_pointer\_compression\_shared\_cage on non-64bit (Shelley Vohr) [#58867](https://github.com/nodejs/node/pull/58867)
...
* \[[`b9cafc540d`](https://github.com/nodejs/node/commit/b9cafc540d)] - **debugger**: fix behavior of plain object exec in debugger repl (Dario Piotrowicz) [#57498](https://github.com/nodejs/node/pull/57498)
* \[[`0a53fac4fa`](https://github.com/nodejs/node/commit/0a53fac4fa)] - **deps**: update zlib to 1.3.1-470d3a2 (Node.js GitHub Bot) [#58628](https://github.com/nodejs/node/pull/58628)
* \[[`84053c9a40`](https://github.com/nodejs/node/commit/84053c9a40)] - **deps**: update zlib to 1.3.0.1-motley-780819f (Node.js GitHub Bot) [#57768](https://github.com/nodejs/node/pull/57768)
* \[[`f40d558f7f`](https://github.com/nodejs/node/commit/f40d558f7f)] - **deps**: update zlib to 1.3.0.1-motley-788cb3c (Node.js GitHub Bot) [#56655](https://github.com/nodejs/node/pull/56655)
* \[[`8303bd2d0e`](https://github.com/nodejs/node/commit/8303bd2d0e)] - **deps**: update archs files for openssl-3.0.16 (Node.js GitHub Bot) [#57335](https://github.com/nodejs/node/pull/57335)
* \[[`2209d71c46`](https://github.com/nodejs/node/commit/2209d71c46)] - **deps**: upgrade openssl sources to quictls/openssl-3.0.16 (Node.js GitHub Bot) [#57335](https://github.com/nodejs/node/pull/57335)
* \[[`5800a0564e`](https://github.com/nodejs/node/commit/5800a0564e)] - **deps**: update cjs-module-lexer to 2.1.0 (Node.js GitHub Bot) [#57180](https://github.com/nodejs/node/pull/57180)
* \[[`f80100dad4`](https://github.com/nodejs/node/commit/f80100dad4)] - **deps**: update cjs-module-lexer to 2.0.0 (Michael Dawson) [#56855](https://github.com/nodejs/node/pull/56855)
* \[[`f6d81913d3`](https://github.com/nodejs/node/commit/f6d81913d3)] - **deps**: update corepack to 0.33.0 (Node.js GitHub Bot) [#58566](https://github.com/nodejs/node/pull/58566)
* \[[`f75758785a`](https://github.com/nodejs/node/commit/f75758785a)] - **deps**: update acorn to 8.15.0 (Node.js GitHub Bot) [#58711](https://github.com/nodejs/node/pull/58711)
* \[[`8a8f94b406`](https://github.com/nodejs/node/commit/8a8f94b406)] - **deps**: update acorn to 8.14.1 (Node.js GitHub Bot) [#57382](https://github.com/nodejs/node/pull/57382)
* \[[`96ec6d5b89`](https://github.com/nodejs/node/commit/96ec6d5b89)] - **deps**: update minimatch to 10.0.3 (Node.js GitHub Bot) [#58712](https://github.com/nodejs/node/pull/58712)
...
* \[[`f315403676`](https://github.com/nodejs/node/commit/f315403676)] - **dns**: remove redundant code using common variable (Deokjin Kim) [#57386](https://github.com/nodejs/node/pull/57386)
* \[[`af68a4c0f1`](https://github.com/nodejs/node/commit/af68a4c0f1)] - **dns**: fix parse memory leaky (theanarkh) [#58973](https://github.com/nodejs/node/pull/58973)
...
* \[[`2b1b657474`](https://github.com/nodejs/node/commit/2b1b657474)] - **doc**: add review guidelines for collaborator nominations (Antoine du Hamel) [#57449](https://github.com/nodejs/node/pull/57449)
* \[[`755446ffb8`](https://github.com/nodejs/node/commit/755446ffb8)] - **doc**: explicit mention arbitrary code execution as a vuln (Rafael Gonzaga) [#57426](https://github.com/nodejs/node/pull/57426)
* \[[`0ac38a150c`](https://github.com/nodejs/node/commit/0ac38a150c)] - **doc**: add JonasBa to collaborators (Jonas Badalic) [#58355](https://github.com/nodejs/node/pull/58355)
* \[[`4ccac5abba`](https://github.com/nodejs/node/commit/4ccac5abba)] - **doc**: add puskin to collaborators (Giovanni Bucci) [#58308](https://github.com/nodejs/node/pull/58308)
* \[[`5bfc75c0b9`](https://github.com/nodejs/node/commit/5bfc75c0b9)] - **doc**: add ovflowd back to core collaborators (Claudio W.) [#58911](https://github.com/nodejs/node/pull/58911)
* \[[`3147cbb42a`](https://github.com/nodejs/node/commit/3147cbb42a)] - **doc**: add info on how project manages social media (Michael Dawson) [#57318](https://github.com/nodejs/node/pull/57318)
* \[[`9cf83a88de`](https://github.com/nodejs/node/commit/9cf83a88de)] - **doc**: ping nodejs/tsc for each security pull request (Rafael Gonzaga) [#57309](https://github.com/nodejs/node/pull/57309)
* \[[`fdf803cdfe`](https://github.com/nodejs/node/commit/fdf803cdfe)] - **doc**: add Filip Skokan to TSC (Rafael Gonzaga) [#58499](https://github.com/nodejs/node/pull/58499)
* \[[`558bbab843`](https://github.com/nodejs/node/commit/558bbab843)] - **doc**: clarify `path.isAbsolute` is not path traversal mitigation (Eric Fortis) [#57073](https://github.com/nodejs/node/pull/57073)
* \[[`de9473bb58`](https://github.com/nodejs/node/commit/de9473bb58)] - **doc**: fix rendering of DEP0174 description (David Sanders) [#56835](https://github.com/nodejs/node/pull/56835)
* \[[`3f51e2db9a`](https://github.com/nodejs/node/commit/3f51e2db9a)] - **doc**: add missing assert return types (Colin Ihrig) [#57219](https://github.com/nodejs/node/pull/57219)
* \[[`8707791768`](https://github.com/nodejs/node/commit/8707791768)] - **doc**: add 1ilsang to triage team (1ilsang) [#57183](https://github.com/nodejs/node/pull/57183)
* \[[`21853cebfb`](https://github.com/nodejs/node/commit/21853cebfb)] - **doc**: add @geeksilva97 to collaborators (Edy Silva) [#57241](https://github.com/nodejs/node/pull/57241)
* \[[`f0e23a7369`](https://github.com/nodejs/node/commit/f0e23a7369)] - **doc**: fix web.libera.chat link in pull-requests.md (Samuel Bronson) [#57076](https://github.com/nodejs/node/pull/57076)
* \[[`0186b1a2cc`](https://github.com/nodejs/node/commit/0186b1a2cc)] - **doc**: remove buffered flag from performance hooks examples (Pavel Romanov) [#52607](https://github.com/nodejs/node/pull/52607)
* \[[`69907727fc`](https://github.com/nodejs/node/commit/69907727fc)] - **doc**: add `module namespace object` links (Dario Piotrowicz) [#57093](https://github.com/nodejs/node/pull/57093)
* \[[`2fcda460ca`](https://github.com/nodejs/node/commit/2fcda460ca)] - **doc**: disambiguate pseudo-code statement (Dario Piotrowicz) [#57092](https://github.com/nodejs/node/pull/57092)
* \[[`25823ade63`](https://github.com/nodejs/node/commit/25823ade63)] - **doc**: fix wrong articles used to address modules (Dario Piotrowicz) [#57090](https://github.com/nodejs/node/pull/57090)
* \[[`671e385b5b`](https://github.com/nodejs/node/commit/671e385b5b)] - **doc**: `modules.md`: fix `distance` definition (Alexander “weej” Jones) [#57046](https://github.com/nodejs/node/pull/57046)
* \[[`64e3474a3f`](https://github.com/nodejs/node/commit/64e3474a3f)] - **doc**: fix wrong verb form (Dario Piotrowicz) [#57091](https://github.com/nodejs/node/pull/57091)
* \[[`2898146c86`](https://github.com/nodejs/node/commit/2898146c86)] - **doc**: add a note about `require('../common')` in testing documentation (Aditi) [#56953](https://github.com/nodejs/node/pull/56953)
* \[[`19b417a2be`](https://github.com/nodejs/node/commit/19b417a2be)] - **doc**: recommend writing tests in new files and including comments (Joyee Cheung) [#57028](https://github.com/nodejs/node/pull/57028)
* \[[`42d6b51291`](https://github.com/nodejs/node/commit/42d6b51291)] - **doc**: improve documentation on argument validation (Aditi) [#56954](https://github.com/nodejs/node/pull/56954)
* \[[`780f945fff`](https://github.com/nodejs/node/commit/780f945fff)] - **doc**: buffer: fix typo on `Buffer.copyBytesFrom(` `offset` option (tpoisseau) [#57015](https://github.com/nodejs/node/pull/57015)
* \[[`26caf97199`](https://github.com/nodejs/node/commit/26caf97199)] - **doc**: update cleanup to trust on vuln db automation (Rafael Gonzaga) [#57004](https://github.com/nodejs/node/pull/57004)
* \[[`b1c432987c`](https://github.com/nodejs/node/commit/b1c432987c)] - **doc**: update post sec release process (Rafael Gonzaga) [#56907](https://github.com/nodejs/node/pull/56907)
* \[[`abac1d1ffa`](https://github.com/nodejs/node/commit/abac1d1ffa)] - **doc**: add section about using npx with permission model (Rafael Gonzaga) [#56539](https://github.com/nodejs/node/pull/56539)
* \[[`671b38c9ee`](https://github.com/nodejs/node/commit/671b38c9ee)] - **doc**: remove RedYetiDev from triagers team (Aviv Keller) [#55947](https://github.com/nodejs/node/pull/55947)
* \[[`d2ad382abf`](https://github.com/nodejs/node/commit/d2ad382abf)] - **doc**: fix relative path mention in --allow-fs (Rafael Gonzaga) [#55791](https://github.com/nodejs/node/pull/55791)
* \[[`c134103aaf`](https://github.com/nodejs/node/commit/c134103aaf)] - **doc**: add scroll margin to links (Roman Reiss) [#58982](https://github.com/nodejs/node/pull/58982)
...
* \[[`0c20633688`](https://github.com/nodejs/node/commit/0c20633688)] - **doc,src,test**: fix typos (Noritaka Kobayashi) [#58477](https://github.com/nodejs/node/pull/58477)
* \[[`79a1555566`](https://github.com/nodejs/node/commit/79a1555566)] - **http**: coerce content-length to number (Marco Ippolito) [#57458](https://github.com/nodejs/node/pull/57458)
* \[[`500b0f7e54`](https://github.com/nodejs/node/commit/500b0f7e54)] - **http2**: fix check for `frame->hd.type` (hanguanqiang) [#57644](https://github.com/nodejs/node/pull/57644)
* \[[`0431b23827`](https://github.com/nodejs/node/commit/0431b23827)] - **lib**: fixup incorrect argument order in assertEncoding (James M Snell) [#57177](https://github.com/nodejs/node/pull/57177)
* \[[`451a1afddc`](https://github.com/nodejs/node/commit/451a1afddc)] - **meta**: add IlyasShabi to collaborators (Ilyas Shabi) [#58916](https://github.com/nodejs/node/pull/58916)
* \[[`6724053b53`](https://github.com/nodejs/node/commit/6724053b53)] - **meta**: bump codecov/codecov-action from 5.4.2 to 5.4.3 (dependabot\[bot]) [#58551](https://github.com/nodejs/node/pull/58551)
* \[[`6a536a4ccf`](https://github.com/nodejs/node/commit/6a536a4ccf)] - **meta**: bump ossf/scorecard-action from 2.4.1 to 2.4.2 (dependabot\[bot]) [#58550](https://github.com/nodejs/node/pull/58550)
* \[[`9993829ffb`](https://github.com/nodejs/node/commit/9993829ffb)] - **meta**: bump rtCamp/action-slack-notify from 2.3.2 to 2.3.3 (dependabot\[bot]) [#58108](https://github.com/nodejs/node/pull/58108)
* \[[`2f0069714e`](https://github.com/nodejs/node/commit/2f0069714e)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#58456](https://github.com/nodejs/node/pull/58456)
* \[[`f6538c607d`](https://github.com/nodejs/node/commit/f6538c607d)] - **meta**: bump codecov/codecov-action from 5.4.0 to 5.4.2 (dependabot\[bot]) [#58110](https://github.com/nodejs/node/pull/58110)
* \[[`5820179278`](https://github.com/nodejs/node/commit/5820179278)] - **meta**: bump actions/download-artifact from 4.2.1 to 4.3.0 (dependabot\[bot]) [#58106](https://github.com/nodejs/node/pull/58106)
* \[[`d5ee6d8830`](https://github.com/nodejs/node/commit/d5ee6d8830)] - **meta**: ignore mailmap changes in linux ci (Jonas Badalic) [#58356](https://github.com/nodejs/node/pull/58356)
* \[[`107a265c97`](https://github.com/nodejs/node/commit/107a265c97)] - **meta**: bump actions/setup-node from 4.3.0 to 4.4.0 (dependabot\[bot]) [#58111](https://github.com/nodejs/node/pull/58111)
* \[[`996ed75276`](https://github.com/nodejs/node/commit/996ed75276)] - **meta**: bump actions/setup-python from 5.5.0 to 5.6.0 (dependabot\[bot]) [#58107](https://github.com/nodejs/node/pull/58107)
* \[[`a504469dc6`](https://github.com/nodejs/node/commit/a504469dc6)] - **meta**: allow penetration testing on live system with prior authorization (Matteo Collina) [#57966](https://github.com/nodejs/node/pull/57966)
* \[[`813a8946ca`](https://github.com/nodejs/node/commit/813a8946ca)] - **meta**: bump actions/setup-python from 5.4.0 to 5.5.0 (dependabot\[bot]) [#57718](https://github.com/nodejs/node/pull/57718)
* \[[`9aef54e210`](https://github.com/nodejs/node/commit/9aef54e210)] - **meta**: bump peter-evans/create-pull-request from 7.0.7 to 7.0.8 (dependabot\[bot]) [#57717](https://github.com/nodejs/node/pull/57717)
* \[[`b7529e7e19`](https://github.com/nodejs/node/commit/b7529e7e19)] - **meta**: bump actions/cache from 4.2.2 to 4.2.3 (dependabot\[bot]) [#57715](https://github.com/nodejs/node/pull/57715)
* \[[`f68cc38d5c`](https://github.com/nodejs/node/commit/f68cc38d5c)] - **meta**: bump actions/setup-node from 4.2.0 to 4.3.0 (dependabot\[bot]) [#57714](https://github.com/nodejs/node/pull/57714)
* \[[`8a3f8d570e`](https://github.com/nodejs/node/commit/8a3f8d570e)] - **meta**: bump actions/upload-artifact from 4.6.1 to 4.6.2 (dependabot\[bot]) [#57713](https://github.com/nodejs/node/pull/57713)
* \[[`bfb6301418`](https://github.com/nodejs/node/commit/bfb6301418)] - **meta**: add some clarification to the nomination process (James M Snell) [#57503](https://github.com/nodejs/node/pull/57503)
* \[[`b9e8657b3a`](https://github.com/nodejs/node/commit/b9e8657b3a)] - **meta**: remove collaborator self-nomination (Rich Trott) [#57537](https://github.com/nodejs/node/pull/57537)
* \[[`640e812c47`](https://github.com/nodejs/node/commit/640e812c47)] - **meta**: edit collaborator nomination process (Antoine du Hamel) [#57483](https://github.com/nodejs/node/pull/57483)
* \[[`6d04c9b8c8`](https://github.com/nodejs/node/commit/6d04c9b8c8)] - **meta**: move ovflowd to emeritus (Claudio W.) [#57443](https://github.com/nodejs/node/pull/57443)
* \[[`2e8f063d2b`](https://github.com/nodejs/node/commit/2e8f063d2b)] - **meta**: bump codecov/codecov-action from 5.3.1 to 5.4.0 (dependabot\[bot]) [#57257](https://github.com/nodejs/node/pull/57257)
* \[[`2c1e1e9324`](https://github.com/nodejs/node/commit/2c1e1e9324)] - **meta**: bump ossf/scorecard-action from 2.4.0 to 2.4.1 (dependabot\[bot]) [#57253](https://github.com/nodejs/node/pull/57253)
* \[[`234b320cf1`](https://github.com/nodejs/node/commit/234b320cf1)] - **meta**: move RaisinTen back to collaborators, triagers and SEA champion (Darshan Sen) [#57292](https://github.com/nodejs/node/pull/57292)
* \[[`5c457335f0`](https://github.com/nodejs/node/commit/5c457335f0)] - **meta**: bump peter-evans/create-pull-request from 7.0.6 to 7.0.7 (dependabot\[bot]) [#57259](https://github.com/nodejs/node/pull/57259)
* \[[`567dd3ef80`](https://github.com/nodejs/node/commit/567dd3ef80)] - **meta**: bump actions/cache from 4.2.0 to 4.2.2 (dependabot\[bot]) [#57256](https://github.com/nodejs/node/pull/57256)
* \[[`ff00fd281f`](https://github.com/nodejs/node/commit/ff00fd281f)] - **meta**: bump actions/upload-artifact from 4.6.0 to 4.6.1 (dependabot\[bot]) [#57255](https://github.com/nodejs/node/pull/57255)
* \[[`a346920854`](https://github.com/nodejs/node/commit/a346920854)] - **meta**: bump `actions/setup-python` from 5.3.0 to 5.4.0 (dependabot\[bot]) [#56867](https://github.com/nodejs/node/pull/56867)
* \[[`118a973ca6`](https://github.com/nodejs/node/commit/118a973ca6)] - **meta**: bump `peter-evans/create-pull-request` from 7.0.5 to 7.0.6 (dependabot\[bot]) [#56866](https://github.com/nodejs/node/pull/56866)
* \[[`253ecef153`](https://github.com/nodejs/node/commit/253ecef153)] - **meta**: bump `codecov/codecov-action` from 5.0.7 to 5.3.1 (dependabot\[bot]) [#56864](https://github.com/nodejs/node/pull/56864)
* \[[`f5e70f50d9`](https://github.com/nodejs/node/commit/f5e70f50d9)] - **meta**: bump `actions/cache` from 4.1.2 to 4.2.0 (dependabot\[bot]) [#56862](https://github.com/nodejs/node/pull/56862)
* \[[`080271e9e3`](https://github.com/nodejs/node/commit/080271e9e3)] - **meta**: bump `actions/stale` from 9.0.0 to 9.1.0 (dependabot\[bot]) [#56860](https://github.com/nodejs/node/pull/56860)
* \[[`a3a83e420b`](https://github.com/nodejs/node/commit/a3a83e420b)] - **meta**: update last name for jkrems (Jan Martin) [#57006](https://github.com/nodejs/node/pull/57006)
* \[[`bb4afcf9a8`](https://github.com/nodejs/node/commit/bb4afcf9a8)] - **meta**: bump `actions/upload-artifact` from 4.4.3 to 4.6.0 (dependabot\[bot]) [#56861](https://github.com/nodejs/node/pull/56861)
* \[[`886fddaa53`](https://github.com/nodejs/node/commit/886fddaa53)] - **meta**: bump `actions/setup-node` from 4.1.0 to 4.2.0 (dependabot\[bot]) [#56868](https://github.com/nodejs/node/pull/56868)
* \[[`ecf565f5d5`](https://github.com/nodejs/node/commit/ecf565f5d5)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#56889](https://github.com/nodejs/node/pull/56889)
* \[[`622281cf48`](https://github.com/nodejs/node/commit/622281cf48)] - **meta**: add @nodejs/url as codeowner (Chengzhong Wu) [#56783](https://github.com/nodejs/node/pull/56783)
* \[[`f44d0a3807`](https://github.com/nodejs/node/commit/f44d0a3807)] - **meta**: bump github/codeql-action from 3.28.18 to 3.29.2 (dependabot\[bot]) [#58922](https://github.com/nodejs/node/pull/58922)
* \[[`49acce8d55`](https://github.com/nodejs/node/commit/49acce8d55)] - **meta**: bump github/codeql-action from 3.28.16 to 3.28.18 (dependabot\[bot]) [#58552](https://github.com/nodejs/node/pull/58552)
* \[[`5f36e0d418`](https://github.com/nodejs/node/commit/5f36e0d418)] - **meta**: bump github/codeql-action from 3.28.11 to 3.28.16 (dependabot\[bot]) [#58112](https://github.com/nodejs/node/pull/58112)
* \[[`847b48ae81`](https://github.com/nodejs/node/commit/847b48ae81)] - **meta**: bump github/codeql-action from 3.28.10 to 3.28.13 (dependabot\[bot]) [#57716](https://github.com/nodejs/node/pull/57716)
* \[[`ec0f1b9281`](https://github.com/nodejs/node/commit/ec0f1b9281)] - **meta**: bump github/codeql-action from 3.28.8 to 3.28.10 (dependabot\[bot]) [#57254](https://github.com/nodejs/node/pull/57254)
* \[[`a47650e828`](https://github.com/nodejs/node/commit/a47650e828)] - **meta**: bump `github/codeql-action` from 3.27.5 to 3.28.8 (dependabot\[bot]) [#56859](https://github.com/nodejs/node/pull/56859)
* \[[`5ed29f4f1a`](https://github.com/nodejs/node/commit/5ed29f4f1a)] - **meta**: bump step-security/harden-runner from 2.12.0 to 2.12.2 (dependabot\[bot]) [#58923](https://github.com/nodejs/node/pull/58923)
* \[[`1b3dc540b4`](https://github.com/nodejs/node/commit/1b3dc540b4)] - **meta**: bump step-security/harden-runner from 2.11.0 to 2.12.0 (dependabot\[bot]) [#58109](https://github.com/nodejs/node/pull/58109)
* \[[`09221fb890`](https://github.com/nodejs/node/commit/09221fb890)] - **meta**: bump step-security/harden-runner from 2.10.4 to 2.11.0 (dependabot\[bot]) [#57258](https://github.com/nodejs/node/pull/57258)
* \[[`71e9381a16`](https://github.com/nodejs/node/commit/71e9381a16)] - **meta**: bump `step-security/harden-runner` from 2.10.2 to 2.10.4 (dependabot\[bot]) [#56863](https://github.com/nodejs/node/pull/56863)
* \[[`7445828f5d`](https://github.com/nodejs/node/commit/7445828f5d)] - **module**: throw error when re-runing errored module jobs (Joyee Cheung) [#58957](https://github.com/nodejs/node/pull/58957)
* \[[`09d478323b`](https://github.com/nodejs/node/commit/09d478323b)] - **module**: allow cycles in require() in the CJS handling in ESM loader (Joyee Cheung) [#58598](https://github.com/nodejs/node/pull/58598)
* \[[`072b253d0b`](https://github.com/nodejs/node/commit/072b253d0b)] - **module**: clarify cjs global-like error on ModuleJobSync (Carlos Espa) [#56491](https://github.com/nodejs/node/pull/56491)
* \[[`3b67aa3f53`](https://github.com/nodejs/node/commit/3b67aa3f53)] - **module**: handle instantiated async module jobs in require(esm) (Joyee Cheung) [#58067](https://github.com/nodejs/node/pull/58067)
* \[[`dd55033989`](https://github.com/nodejs/node/commit/dd55033989)] - **module**: fix incorrect formatting in require(esm) cycle error message (haykam821) [#57453](https://github.com/nodejs/node/pull/57453)
* \[[`47ff40e8a7`](https://github.com/nodejs/node/commit/47ff40e8a7)] - **module**: handle cached linked async jobs in require(esm) (Joyee Cheung) [#57187](https://github.com/nodejs/node/pull/57187)
* \[[`9050963c5e`](https://github.com/nodejs/node/commit/9050963c5e)] - **module**: improve error message from asynchronicity in require(esm) (Joyee Cheung) [#57126](https://github.com/nodejs/node/pull/57126)
* \[[`d514be30f5`](https://github.com/nodejs/node/commit/d514be30f5)] - **module**: handle .mjs in .js handler in CommonJS (Joyee Cheung) [#55590](https://github.com/nodejs/node/pull/55590)
* \[[`3c4a073131`](https://github.com/nodejs/node/commit/3c4a073131)] - **module**: fix require.resolve() crash on non-string paths (Aditi) [#56942](https://github.com/nodejs/node/pull/56942)
* \[[`0cfcb7846d`](https://github.com/nodejs/node/commit/0cfcb7846d)] - **os**: fix GetInterfaceAddresses memory lieaky (theanarkh) [#58940](https://github.com/nodejs/node/pull/58940)
* \[[`7f8d1b2681`](https://github.com/nodejs/node/commit/7f8d1b2681)] - **permission**: ignore internalModuleStat on module loading (Rafael Gonzaga) [#55797](https://github.com/nodejs/node/pull/55797)
* \[[`47ec8fe215`](https://github.com/nodejs/node/commit/47ec8fe215)] - **readline**: fix unresolved promise on abortion (Daniel Venable) [#54030](https://github.com/nodejs/node/pull/54030)
* \[[`9b2edb7db4`](https://github.com/nodejs/node/commit/9b2edb7db4)] - **repl**: avoid deprecated `require.extensions` in tab completion (baki gul) [#58653](https://github.com/nodejs/node/pull/58653)
* \[[`4879bd39fa`](https://github.com/nodejs/node/commit/4879bd39fa)] - **repl**: fix tab completion not working with computer string properties (Dario Piotrowicz) [#58709](https://github.com/nodejs/node/pull/58709)
* \[[`4a3d5b8d90`](https://github.com/nodejs/node/commit/4a3d5b8d90)] - **src**: do not format single string argument for THROW\_ERR\_\* (Joyee Cheung) [#57126](https://github.com/nodejs/node/pull/57126)
* \[[`1e389e3f28`](https://github.com/nodejs/node/commit/1e389e3f28)] - **src**: fixup errorhandling more in various places (James M Snell) [#57852](https://github.com/nodejs/node/pull/57852)
* \[[`0f8968ea26`](https://github.com/nodejs/node/commit/0f8968ea26)] - **src**: fix module buffer allocation (X-BW) [#57738](https://github.com/nodejs/node/pull/57738)
* \[[`dfab0f662b`](https://github.com/nodejs/node/commit/dfab0f662b)] - **src**: fix build when using shared simdutf (Antoine du Hamel) [#58407](https://github.com/nodejs/node/pull/58407)
* \[[`bed96ce098`](https://github.com/nodejs/node/commit/bed96ce098)] - **src**: fix possible dereference of null pointer (Eusgor) [#58459](https://github.com/nodejs/node/pull/58459)
* \[[`0dbb163aa4`](https://github.com/nodejs/node/commit/0dbb163aa4)] - **src**: fix FIPS init error handling (Tobias Nießen) [#58379](https://github.com/nodejs/node/pull/58379)
* \[[`f53a6eb30c`](https://github.com/nodejs/node/commit/f53a6eb30c)] - **src**: fix -Wunreachable-code in src/node\_api.cc (Shelley Vohr) [#58901](https://github.com/nodejs/node/pull/58901)
* \[[`a0b60aa189`](https://github.com/nodejs/node/commit/a0b60aa189)] - **tools**: update coverage GitHub Actions to fixed version (Rich Trott) [#59512](https://github.com/nodejs/node/pull/59512)
...
* \[[`f9f17e3ef6`](https://github.com/nodejs/node/commit/f9f17e3ef6)] - **util**: fix formatting of objects with built-in Symbol.toPrimitive (Shima Ryuhei) [#57832](https://github.com/nodejs/node/pull/57832)
* \[[`4ceae2f07a`](https://github.com/nodejs/node/commit/4ceae2f07a)] - **util**: fix parseEnv incorrectly splitting multiple ‘=‘ in value (HEESEUNG) [#57421](https://github.com/nodejs/node/pull/57421)
* \[[`30e25049b9`](https://github.com/nodejs/node/commit/30e25049b9)] - **v8**: fix missing callback in heap utils destroy (Ruben Bridgewater) [#58846](https://github.com/nodejs/node/pull/58846)
* \[[`d69d284940`](https://github.com/nodejs/node/commit/d69d284940)] - **vm**: import call should return a promise in the current context (Chengzhong Wu) [#58309](https://github.com/nodejs/node/pull/58309)
* \[[`1aa21ee59f`](https://github.com/nodejs/node/commit/1aa21ee59f)] - **win,build**: fix MSVS v17.14 compilation issue (StefanStojanovic) [#58902](https://github.com/nodejs/node/pull/58902)
* \[[`516fc9f132`](https://github.com/nodejs/node/commit/516fc9f132)] - **win,tools**: use Azure Trusted Signing (Stefan Stojanovic) [#58502](https://github.com/nodejs/node/pull/58502)
* \[[`d0770381d8`](https://github.com/nodejs/node/commit/d0770381d8)] - **zlib**: remove mentions of unexposed Z\_TREES constant (Jimmy Leung) [#58371](https://github.com/nodejs/node/pull/58371)
* \[[`9766899fbd`](https://github.com/nodejs/node/commit/9766899fbd)] - **zlib**: fix pointer alignment (jhofstee) [#57727](https://github.com/nodejs/node/pull/57727)
